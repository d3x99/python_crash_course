...
# inviting using for loop
for guest in guest_list:
	print('I invite you ' + guest  + ' for dinner in my house')
	
print("\n Sorry my guests but table won't arrive in time for dinner, i cant invite only 2 guests\n")
# deleting and apologizing to guests
for person in range(len(guest_list)):
	if len(guest_list) > 2:
		guest = guest_list.pop()
		print('Sorry ' + guest + ' but i dont have seat for u')
		
print('\nHey ' + guest_list[0] + ' you are still invited. Hope to see you soon')
print('Hey ' + guest_list[1] + ' you are still invited. Hope to see you soon')

#deleting rest of guest on list
del guest_list[:]
print(guest_list)
